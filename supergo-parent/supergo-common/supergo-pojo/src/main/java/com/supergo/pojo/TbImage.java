...
public class TbImage implements Serializable {
	...
	private static final long serialVersionUID = -2688528407968036469L;
	...
	public String toString() {
		return "TbImage [imgId=" + imgId + ", goodsId=" + goodsId + ", imgColor=" + imgColor + ", imgPath=" + imgPath
				+ ", imgSuffix=" + imgSuffix + ", isMaster=" + isMaster + ", imgOrder=" + imgOrder + ", createId="
