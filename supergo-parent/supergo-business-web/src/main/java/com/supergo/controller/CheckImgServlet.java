 ...
 *
 */
public class CheckImgServlet extends HttpServlet implements Serializable {
	private static final long serialVersionUID = 7252789568983576207L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (int i = 0; i < 4; i++) {
			...
			checkCode = checkCode + String.valueOf(c);
			// 将生成汉字 加入buffer
			// buffer.append(c);
