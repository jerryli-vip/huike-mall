...
<head>
	...
	<title>Super购，优质！优质！</title>
	 <link rel="icon" href="assets/img/favicon.ico">

    <link rel="stylesheet" type="text/css" href="//static.supergo.com/css/webbase.css" />
    <link rel="stylesheet" type="text/css" href="//static.supergo.com/css/pages-JD-index.css" />
    <link rel="stylesheet" type="text/css" href="//static.supergo.com/css/widget-jquery.autocomplete.css" />
	...
	<#-- 编写配置js文件 -->
	<script src="//static.supergo.com/js/supergo/index.js"></script>
</head>

<body ng-app="supergo" ng-controller="indexController">
	<#-- 头部栏位 -->
	<#--页面顶部-->
<div id="nav-bottom">
	<#--顶部-->
	<div class="nav-top">
		<div class="top">
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						<li class="f-item">Super购欢迎您！</li>
						<li class="f-item">请<a href="//sso.supergo.com/login.html" target="_blank">登录</a>　<span><a href="//sso.supergo.com/register.html" target="_blank">免费注册</a></span></li>
					</ul>
					<ul class="fr">
						<li class="f-item">我的订单</li>
						<li class="f-item space"></li>
						<li class="f-item"><a href="home.html" target="_blank">我的Super购</a></li>
						<li class="f-item space"></li>
						<li class="f-item">Super购会员</li>
						<li class="f-item space"></li>
						<li class="f-item">企业采购</li>
						<li class="f-item space"></li>
						<li class="f-item">关注Super购</li>
						<li class="f-item space"></li>
			...
			<div class="py-container">
				<div class="yui3-g Logo">
					<div class="yui3-u Left logoArea">
						<a class="logo-bd" title="Super购" href="//www.supergo.com/index.html" target="_blank"></a>
					</div>
						...
						<div class="item bo">
							...
							<div class="item-list clearfix">
								<div class="subitem">
									<dl class="fore1">
										<dt><a href="">电子书</a></dt>
										<dd><em><a href="//search.supergo.com/search.html?cid=1">婚恋/两性</a></em><em><a href="">文学</a></em><em><a href="">经管</a></em><em><a href="">畅读VIP</a></em></dd>
									</dl>
									<dl class="fore2">
										<dt><a href="">数字音乐</a></dt>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				...
				<li class="yui3-u-5-24">
					<a href="${rec.url}" target="_blank"><img src="${rec.pic}" /></a>
				</li>
				</#list>
			</ul>
		</div>
				...
				<#list like as lik>
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="${lik.url}" class="pic"><img src="${lik.pic}" alt="" /></a>
								<div class="like-text">
		...
		<div class="py-container">
			...
			<div class="clearfix yui3-g Interest">
				...
				<div class="yui3-u row-165 brandArea">
					...
					<#list interesting4 as int4>
						<li class="yui3-u-1-2 brand-pit"><img src="${int4.pic}" /></li>
					</#list>
					</ul>
				</div>
			</div>
					...
					<div class="yui3-g Floor-1">
						...
						<div class="yui3-u row-330 floorBanner">
							<div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
								...
								<div class="carousel-inner">
									<div class="active item">
										<img src="//static.supergo.com/img/floor-1-b01.png">
									</div>
									<div class="item">
										<img src="//static.supergo.com/img/floor-1-b02.png">
									</div>
									<div class="item">
										<img src="//static.supergo.com/img/floor-1-b03.png">
									</div>
								</div>
...
<script type="text/javascript" src="//static.supergo.com/js/czFunction.js"></script>
...
<script type="text/javascript" src="//static.supergo.com/js/pages/index.js"></script>
<script type="text/javascript" src="//static.supergo.com/js/widget/cartPanelView.js"></script>
<script type="text/javascript" src="//static.supergo.com/js/widget/jquery.autocomplete.js"></script>
<script type="text/javascript" src="//static.supergo.com/js/widget/nav.js"></script>
</body>
